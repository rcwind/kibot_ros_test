...
import tf
from kibot_nav.transform_utils import quat_to_angle, normalize_angle
from math import radians, copysign, sqrt, pow, pi

class OutAndBack():
    def __init__(self):
        # Give the node a name
        rospy.init_node('odom_out_and_back')
        ...
        for i in range(2):
            ...
            while abs(turn_angle + angular_tolerance) < abs(goal_angle) and not rospy.is_shutdown():
                ...
                rospy.loginfo("turn_angle is " + str(turn_angle / pi * 180.0) + " degree")
                last_angle = rotation
